...
format: directives and comments take a `!` prefix, and every other line
goes to the instrument verbatim. The unprefixed form below is to be
accepted with a warning through 0.3.x and removed at 0.4.0.
