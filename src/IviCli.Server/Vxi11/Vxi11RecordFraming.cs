...
/// <summary>
/// ONC RPC record-marking framing (RFC 1831 §10) over a
/// <see cref="System.IO.Stream"/>. Kept inside the Server layer rather
/// than in <c>IviCli.Domain.Protocols</c> because <c>Stream</c>-level
/// IO is an infrastructure concern; the Domain layer hosts pure byte
/// primitives only.
/// </summary>
public static class Vxi11RecordFraming
{
    ...
    /// returns its payload (without the 4-byte header). v1 expects
